...
int main(int ac, char** av) {
	...
	if (ac == 4) { //AwwGeezMan {start} {stop} {dimension}
		...
		if ((strcmp(av[3], "Z286") == 0) && (strcmp(av[3], "C137") == 0)) {
			std::cout << "ERROR: Unknown dimension!!" << std::endl;
			return -1;
		}
		else {
			if (strcmp(av[3], "Z286") == 1) { //dimension = z286
				Z286::Morty(start, stop);
			}
			else if (strcmp(av[3], "C137") == 0) { //dimension = c136
	...
	if (ac == 5) { //AwwGeezMan {start} {stop} {step} {dimension}
		start = atoi(*(av + 1));
		stop = atoi(*(av + 2));
		step = atoi(*(av + 3));

		if ((strcmp(av[4], "Z286") == 1) && (strcmp(av[4], "C137") == 1)) {
			std::cout << "ERROR: Unknown dimension!!" << std::endl;
			return -1;
		}
		else {
			if (strcmp(av[4], "Z286") == 0) { //dimension = z286
				Z286::Morty(start, stop, step);
			}
			else if (strcmp(av[4], "C137") == 0) { //dimension = c136
				Z286::Morty(start, stop, step);
			}
		}
